    ...
    <div className="bg-white">
        ...
        >
          ...
          <div className="flex lg:hidden">
            <button
              ...
              className="bg- -m-2.5 mx-3 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700"
            >
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-mx-3 mt-2 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                    >
                      {item.name}
                    </a>
                  ))}
      ...
      <main>
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-32 lg:px-8">
          ...
          <p className="mx-auto my-9 mt-6 max-w-2xl text-pretty text-center text-lg font-medium text-gray-600 sm:text-xl/8">
